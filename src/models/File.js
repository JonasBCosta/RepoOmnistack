...
//Deve ser acessado neste formato de função pois com arrow functions não é possível acessar o "this" para acessar a instancia desta classe
    ...
    return `${url}/files/${encodeURIComponent(this.path)}`; // Com apostrophe é possível acessar variáveis, diferentemente com aspas. encodedURIComponent vai acessar o dado em formato de URL. E acessa a variável de path da própria instancia
